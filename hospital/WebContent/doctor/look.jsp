...
<table class="table table-bordered table-hover definewidth m10">
    ...
    <tr>
        ...
        <td>
        	 <c:if test="${doctor.gender == 1 }">男</c:if>
        	 <c:if test="${doctor.gender == 0 }">女</c:if>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>
        	<!-- 使用日期格式化标签完成日期信息格式的转换！ -->
        	<fmt:formatDate value="${doctor.birthday }" pattern="yyyy-MM-dd HH:mm:ss"/>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>
        	<c:if test="${doctor.degree == 1 }">专科</c:if>
        	<c:if test="${doctor.degree == 2 }">本科</c:if>
        	<c:if test="${doctor.degree == 3 }">研究生</c:if>
        	<c:if test="${doctor.degree == 4 }">博士生</c:if>
        </td>
    </tr>
	<tr>
